...
+ (void)load{
    ...
    dispatch_once(&onceToken, ^{
        ...
        [self exchangeInstance:[NSNotificationCenter class] selector:@selector(addObserver:selector:name:object:) withSwizzledSelector:@selector(safe_addObserver:selector:name:object:)];
    });
}
