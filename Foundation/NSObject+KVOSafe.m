...
+ (void)load{
    ...
    dispatch_once(&onceToken, ^{
        ...
        [self exchangeInstance:[self class] selector:@selector(addObserver:forKeyPath:options:context:) withSwizzledSelector:@selector(safe_addObserver:forKeyPath:options:context:)];
        [self exchangeInstance:[self class] selector:@selector(observeValueForKeyPath:ofObject:change:context:) withSwizzledSelector:@selector(safe_observeValueForKeyPath:ofObject:change:context:)];
        [self exchangeInstance:[self class] selector:@selector(removeObserver:forKeyPath:) withSwizzledSelector:@selector(safe_removeObserver:forKeyPath:)];
        [self exchangeInstance:[self class] selector:@selector(removeObserver:forKeyPath:context:) withSwizzledSelector:@selector(safe_removeObserver:forKeyPath:context:)];
    });
}
